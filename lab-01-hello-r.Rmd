...
The file has 1846 rows with 3 variables.
The variable names are **data-set** , **x** and **y**. 
...
The corellation coefficient is **-0.06447185**.
...
ggplot(data = star_data, mapping = aes(x = x, y = y)) +
  geom_point()
```
The values for the Star dataset are different by 0.00151075.
...
ggplot(data = star_data, mapping = aes(x = x, y = y)) +
  geom_point()
```
The values for the circle dataset are different from the dino data by  0.00387151.
